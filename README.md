...
3. <img width="1078" height="796" alt="image" src="https://github.com/user-attachments/assets/3fd97ef9-14ae-433f-bfbd-bd5b0a27cfc8" />

   The state machine used in the vertical slice is the player animation state machine. The animator has three paramaters: the float speed, float directionZ and the boolean
